...
//
//     final tvMazeApiModel = tvMazeApiModelFromJson(jsonString);

import 'dart:convert';

List<TvMazeApiModel> tvMazeApiModelFromJson(String str) =>
    List<TvMazeApiModel>.from(
      json.decode(str).map((x) => TvMazeApiModel.fromJson(x)),
    );

String tvMazeApiModelToJson(List<TvMazeApiModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class TvMazeApiModel {
  int id;
  String url;
  String name;
  Type type;
  ...
  factory TvMazeApiModel.fromJson(Map<String, dynamic> json) => TvMazeApiModel(
    id: json["id"],
    url: json["url"],
    name: json["name"],
