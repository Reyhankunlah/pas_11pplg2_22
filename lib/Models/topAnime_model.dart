...
class TopAnimeModel {
  ...
  TopAnimeModel({required this.pagination, required this.data});
...
enum Season { FALL, SPRING, WINTER }
...
enum DatumType { MOVIE, OVA, TV, TV_SPECIAL }

final datumTypeValues = EnumValues({
  "Movie": DatumType.MOVIE,
  "OVA": DatumType.OVA,
  "TV": DatumType.TV,
  "TV Special": DatumType.TV_SPECIAL,
});
